...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, caption="Nih Asupan Buat Kamu 🤤", file=pantek
        )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, caption="Nih Ayang Nya Kamu 😬😚", file=kompor
        )
        await bubur.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(event.chat.id, caption="Nih Kak PP Couplenya 😁", file=roko)
        await liong.delete()
    except Exception:
