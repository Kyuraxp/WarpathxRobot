...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nOwner Of A Bot. Queen Of @kitarohey. Bot Name Inspired From 'JoJo'."
        disaster_level_present = True
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/kitarochannel"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/rumahkitaroo"
                            ),
                        ],
                    ]
                ),
...
def stats(update: Update, context: CallbackContext):
    stats = (
        "❂ <b>Stats For <a href='https://t.me/ScarlettRobot'>Scarlet</a>:</b>\n"
