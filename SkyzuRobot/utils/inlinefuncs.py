...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/KyuraxRobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Kyura Robot ❤️](https://t.me/KyuraxRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER](t.me/kyuraxx)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/2bec228f120213c68a0b0.jpg",
            input_message_content=InputTextMessageContent(
...
async def music_inline_func(answers, query):
    chat_id = -1001575341991
    group_invite = "https://t.me/joinchat/QEt5dXJhUHJvamVjdHM="
    try:
        messages = [
            m
