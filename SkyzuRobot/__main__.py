...
✪ Maintained by [Kitaro](https://t.me//kitarohey) ✨
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/Kitaroo/KitaroRobot"
        ),
...
EMI_IMG = "https://telegra.ph/file/42fb2fb2fcfce9ff342ac.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @kitarohey \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"<b>Hai saya Scarlet Robot!</b>\n<b>Mulai dalam since:</b> <code>{uptime}</code>",
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            text="๏ I'm *Scarlet*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Scarlet's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for ScarletRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on Scarlet.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/rumahkitaroo"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇs​", url="https://t.me/kitarochannel"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for Scarlet</b>\n"
            f"\nHere Developers Making The ScarletRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="kitaro", url="t.me/kitarohey"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
                    ],
